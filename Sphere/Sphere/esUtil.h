...
typedef struct ESContext
{
   ...
   GLint degreeY;
    ...
    void (* updateTextureData)(ESContext *esContext, GLfloat textureWidth, GLfloat textureHeight, GLubyte *textureData);
} ESContext;
...
// https://github.com/ohadpr/ipad-terrain-engine/blob/master/Classes/ES2Renderer.m#L144
